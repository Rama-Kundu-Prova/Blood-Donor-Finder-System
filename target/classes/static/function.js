       ...
       function selectDistrict(s1,s2)
        ...
        function selectThana(s1,s2)
        {
            ...
            if(s1.value=="Dhaka")
            {
                var optionArray=['choose|Choose Thana/Upozila','Adabar Thana|Adabar Thana','Badda Thana|Badda Thana ','Bangshal Thana|Bangshal Thana','Bhashantek Thana|Bhashantek Thana ','Bhatara Thana|Bhatara Thana',
                ...
                'Kadamtoli Thana|Kadamtoli Thana','Kafrul Thana|Kafrul Thana','Keraniganj Upazila|Keraniganj Upazila ','Nawabganj Upazila|Nawabganj Upazila',
        ...
        function selectUnion(s1,s2)
        {
            ...
            else if(s1.value=="Dohar Upazila")
            {
	 		 var optionArray=['choose|Choose Union','Bilashpur|Bilashpur ','Kushumhati|Kushumhati','Mahmudpur|Mahmudpur ','Moksedpur|Moksedpur','Narisha|Narisha ','Nayabari|Nayabari',
                'Raipara|Raipara ','Sutarpara|Sutarpara ','Shimulia|Shimulia'];
	
			}
			 else if(s1.value=="Keraniganj Upazila")
            {
                var optionArray=['choose|Choose Union','Aganagar|Aganagar','Basta|Basta ','Hazratpur|Hazratpur','Kalatia|Kalatia ','Kalindi|Kalindi',
                'Konda|Konda ','Ruhitpur|Ruhitpur ','Sakta|Sakta ','Subhadya|Subhadya','Taranagar|Taranagar','Tegharia|Tegharia',
                'Zinjira|Zinjira'];
            }
             else   if(s1.value=="Nawabganj Upazila")
            {
                var optionArray=['choose|Choose Union','Agla|Agla','Bakshnagar|Bakshnagar ','Bandura|Bandura','Barrah|Barrah ','Baruakhali|Baruakhali',
                'Churain|Churain ','Galimpur|Galimpur ','Jantrail|Jantrail ','Joykrishnapur|Joykrishnapur',
                'Koilail|Koilail','Kalakopa|Kalakopa','Nayansree|Nayansree','Shikaripara|Shikaripara',
                'Sholla|Sholla'];
            }
